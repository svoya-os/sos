...
|---|---|---|---|---|---|---|---|---|
| laya (convaiinnovations/laya/multilingual) | ru | 74 | 59% | 22/60 | 0 | 14/14 | 424 / 436 | 0 |
| laya (convaiinnovations/laya/multilingual) | en | 35 | 63% | 18/28 | 1 | 7/7 | 352 / 363 | 0 |
| laya (convaiinnovations/laya/multilingual) | all | 109 | 61% | 40/88 | 1 | 21/21 | 420 / 435 | 0 |
| laya (Router: checkpoint by language) | ru | 74 | 59% | 22/60 | 0 | 14/14 | 419 / 431 | 0 |
| laya (Router: checkpoint by language) | en | 35 | 23% | 8/28 | 0 | 7/7 | 898 / 925 | 0 |
| laya (Router: checkpoint by language) | all | 109 | 48% | 30/88 | 0 | 21/21 | 422 / 922 | 0 |
| llm (jackson/decide.py) | ru | 74 | 95% | 56/60 | 0 | 14/14 | 13275 / 13571 | 0 |
| llm (jackson/decide.py) | en | 35 | 97% | 28/28 | 0 | 7/7 | 10452 / 10743 | 0 |
| llm (jackson/decide.py) | all | 109 | 95% | 84/88 | 0 | 21/21 | 13248 / 13502 | 0 |
...
- laya (convaiinnovations/laya/multilingual) · ru · «сколько стоит новая батарея для ноутбука»: expected none, picked battery (p 1.00), did none
...
- laya (convaiinnovations/laya/multilingual) · ru · «скинь скриншот в телеграм»: expected none, picked screenshot (p 0.98), did none
...
- laya (Router: checkpoint by language) · ru · «сколько стоит новая батарея для ноутбука»: expected none, picked battery (p 1.00), did none
...
- laya (Router: checkpoint by language) · ru · «скинь скриншот в телеграм»: expected none, picked screenshot (p 0.98), did none
...
- llm (jackson/decide.py) · ru · «запиши видео с экрана»: expected none, picked screenshot (p 0.95), did none
- llm (jackson/decide.py) · ru · «скинь скриншот в телеграм»: expected none, picked screenshot (p 0.99), did none
