...
| 7 | desktop | wait_serial | ok | 8.0s | matched 'SOS-MARK 16.14 desktop-ready' |
...
| 12 | launcher | screenshot | ok | 0.8s | 1440x900 (pillow), 31.6% changed vs 03-live-desktop |
...
| 17 | jackson | screenshot | ok | 1.0s | 1440x900 (pillow), 21.8% changed vs 03-live-desktop |
