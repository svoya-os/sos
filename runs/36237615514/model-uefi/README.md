...
| 4 | desktop | wait_serial | ok | 21.0s | matched 'SOS-MARK 18.32 desktop-ready' |
| 5 | desktop | sleep | ok | 10.0s | slept 10s |
| 6 | desktop | screenshot | ok | 1.1s | 1440x900 (pillow) |
| 7 | network | wait_serial | ok | 0.0s | matched 'SOS-MARK 10.13 network-online' |
...
| 15 | install | wait_serial | ok | 0.0s | matched '[   93.349471] sos-vm-test[2216]: SOS-STEP model-ready' |
...
| 28 | ask | wait_serial | failed | 355.0s | serial reported failure: '[  487.976852] jacksond[1399]: INFO jackson.engine: turn failed after 361149 ms: The model failed: local: no answer from 127.0.0.1:808 |
| 29 | ask | sleep | ok | 2.0s | slept 2s |
| 30 | ask | screenshot | ok | 1.3s | 1440x900 (pillow) |
| 31 | skill | type | ok | 2.5s | typed 48 characters |
| 32 | skill | wait_serial | failed | 365.3s | serial reported failure: '[  858.715318] jacksond[1399]: INFO jackson.engine: turn failed after 360293 ms: The model failed: local: no answer from 127.0.0.1:808 |
| 33 | skill | sleep | ok | 2.0s | slept 2s |
| 34 | skill | screenshot | ok | 1.7s | 1440x900 (pillow) |
| 35 | russian | type | ok | 1.8s | typed 34 characters |
| 36 | russian | wait_serial | failed | 364.9s | serial reported failure: '[ 1228.549651] jacksond[1399]: INFO jackson.engine: turn failed after 360296 ms: The model failed: local: no answer from 127.0.0.1:808 |
| 37 | russian | sleep | ok | 2.0s | slept 2s |
| 38 | russian | screenshot | ok | 1.3s | 1440x900 (pillow) |
