...
| 4 | desktop | wait_serial | ok | 21.0s | matched 'SOS-MARK 18.28 desktop-ready' |
...
| 9 | cheatsheet | screenshot | ok | 0.9s | 1440x900 (pillow), 34.0% changed vs 01-desktop |
...
| 34 | jackson-cli | screenshot | ok | 0.8s | 1440x900 (pillow) |
...
| 52 | jackson | screenshot | ok | 0.9s | 1440x900 (pillow) |
| 53 | jackson-fun | type | ok | 0.6s | typed 12 characters |
| 54 | jackson-fun | sleep | ok | 4.0s | slept 4s |
| 55 | jackson-fun | screenshot | ok | 0.9s | 1440x900 (pillow) |
...
| 76 | jackson-install | screenshot | ok | 0.9s | 1440x900 (pillow) |
...
| 87 | launcher-install | screenshot | ok | 0.8s | 1440x900 (pillow) |
...
| 97 | launcher-install | screenshot | ok | 0.8s | 1440x900 (pillow) |
...
| 104 | launcher-eggs | screenshot | ok | 0.8s | 1440x900 (pillow) |
...
| 114 | launcher-eggs | screenshot | ok | 0.9s | 1440x900 (pillow) |
...
| 124 | control | screenshot | ok | 0.7s | 1440x900 (pillow) |
...
| 129 | doctor | screenshot | ok | 0.8s | 1440x900 (pillow) |
...
| 138 | lock | screenshot | ok | 1.1s | 1440x900 (pillow) |
