...
| 4 | desktop | wait_serial | ok | 18.0s | matched 'SOS-MARK 16.38 desktop-ready' |
...
| 10 | installer | wait_serial | ok | 2.0s | matched '[   38.609389] sos-vm-test[1770]: SOS-STEP installer-start' |
| 11 | installer | sleep | ok | 25.0s | slept 25s |
| 12 | welcome | screenshot | ok | 0.5s | 1440x900 (pillow), 64.6% changed vs 01-live-desktop |
...
| 32 | users | screenshot | ok | 0.4s | 1440x900 (pillow) |
...
| 41 | install | screenshot | ok | 0.4s | 1440x900 (pillow) |
| 42 | install | wait_serial | ok | 48.1s | matched '[  236.929200] sos-installer[9632]: installation finalized' |
...
| 51 | greeter | screenshot | ok | 0.6s | 1440x900 (pillow) |
| 52 | login | type | ok | 0.9s | typed 17 characters |
| 53 | login | sleep | ok | 45.0s | slept 45s |
| 54 | login | screenshot | ok | 0.7s | 1440x900 (pillow), 100.0% changed vs 12-greeter |
| 55 | login | sleep | ok | 30.0s | slept 30s |
| 56 | login | screenshot | ok | 0.7s | 1440x900 (pillow) |
