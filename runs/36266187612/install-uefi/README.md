...
| 10 | installer | wait_serial | ok | 2.0s | matched '[   41.276588] sos-vm-test[1787]: SOS-STEP installer-start' |
...
| 42 | install | wait_serial | ok | 90.2s | matched '[  281.474684] sos-installer[9666]: installation finalized' |
