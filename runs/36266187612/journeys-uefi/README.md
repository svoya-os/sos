...
| 4 | desktop | wait_serial | ok | 18.0s | matched 'SOS-MARK 16.33 desktop-ready' |
...
| 9 | cheatsheet | screenshot | ok | 0.6s | 1440x900 (pillow), 30.4% changed vs 01-desktop |
...
| 76 | jackson-install | screenshot | ok | 0.7s | 1440x900 (pillow) |
...
| 87 | launcher-install | screenshot | ok | 0.6s | 1440x900 (pillow) |
...
| 94 | launcher-install | screenshot | ok | 0.6s | 1440x900 (pillow) |
| 95 | launcher-install | key | ok | 0.0s | ret |
| 96 | launcher-install | sleep | ok | 3.0s | slept 3s |
| 97 | launcher-install | screenshot | ok | 0.6s | 1440x900 (pillow) |
...
| 104 | launcher-eggs | screenshot | ok | 0.6s | 1440x900 (pillow) |
| 105 | launcher-eggs | key | ok | 0.0s | ret |
| 106 | launcher-eggs | sleep | ok | 5.0s | slept 5s |
| 107 | launcher-eggs | screenshot | ok | 0.5s | 1440x900 (pillow) |
...
| 114 | launcher-eggs | screenshot | ok | 0.7s | 1440x900 (pillow) |
...
| 119 | launcher-eggs | screenshot | ok | 0.5s | 1440x900 (pillow) |
...
| 124 | control | screenshot | ok | 0.5s | 1440x900 (pillow) |
...
| 129 | doctor | screenshot | ok | 0.6s | 1440x900 (pillow) |
...
| 136 | lock | screenshot | ok | 0.6s | 1440x900 (pillow) |
| 137 | lock | sleep | ok | 5.0s | slept 5s |
| 138 | lock | screenshot | ok | 0.7s | 1440x900 (pillow) |
