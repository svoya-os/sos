...
| 4 | desktop | wait_serial | ok | 21.0s | matched 'SOS-MARK 18.27 desktop-ready' |
| 5 | desktop | sleep | ok | 10.0s | slept 10s |
| 6 | desktop | screenshot | ok | 0.6s | 1440x900 (pillow) |
| 7 | network | wait_serial | ok | 0.0s | matched 'SOS-MARK 10.09 network-online' |
...
| 15 | install | wait_serial | ok | 0.0s | matched '[   89.409852] sos-vm-test[2227]: SOS-STEP model-ready' |
...
| 21 | install | type | ok | 6.5s | typed 127 characters |
...
| 27 | ask | type | ok | 1.4s | typed 28 characters |
| 28 | ask | sleep | ok | 8.0s | slept 8s |
| 29 | ask | screenshot | ok | 0.8s | 1440x900 (pillow) |
| 30 | ask | wait_serial | ok | 454.6s | matched '[  598.866627] jacksond[2249]: INFO jackson.engine: turn done in 460675 ms: local/Qwen3.5-4B-Q4_K_M, 2949+52 tokens' |
| 31 | ask | sleep | ok | 2.0s | slept 2s |
| 32 | ask | screenshot | ok | 0.7s | 1440x900 (pillow) |
| 33 | skill | type | ok | 2.5s | typed 48 characters |
| 34 | skill | wait_serial | ok | 178.2s | matched '[  783.138559] jacksond[2249]: INFO jackson.engine: turn done in 174840 ms: local/Qwen3.5-4B-Q4_K_M, 3808+37 tokens' (#2) |
| 35 | skill | sleep | ok | 2.0s | slept 2s |
| 36 | skill | screenshot | ok | 0.7s | 1440x900 (pillow) |
| 37 | russian | type | ok | 1.8s | typed 34 characters |
| 38 | russian | wait_serial | ok | 57.1s | matched '[  844.277069] jacksond[2249]: INFO jackson.engine: turn done in 54170 ms: local/Qwen3.5-4B-Q4_K_M, 3183+16 tokens' (#3) |
