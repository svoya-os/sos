...
| 7 | desktop | wait_serial | ok | 10.0s | matched 'SOS-MARK 18.26 desktop-ready' |
| 8 | desktop | sleep | ok | 8.0s | slept 8s |
| 9 | desktop | screenshot | ok | 0.6s | 1440x900 (pillow) |
| 10 | network | wait_serial | ok | 0.0s | matched 'SOS-MARK 10.13 network-online' |
...
| 18 | jackson | screenshot | ok | 0.8s | 1440x900 (pillow), 12.8% changed vs 03-live-desktop |
