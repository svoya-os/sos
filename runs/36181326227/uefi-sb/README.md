...
| 6 | plymouth | screenshot | ok | 0.1s | 1440x900 (pillow) |
| 7 | desktop | wait_serial | ok | 9.0s | matched 'SOS-MARK 16.43 desktop-ready' |
...
| 12 | launcher | screenshot | ok | 0.6s | 1440x900 (pillow), 28.0% changed vs 03-live-desktop |
...
| 17 | jackson | screenshot | ok | 0.6s | 1440x900 (pillow), 18.6% changed vs 03-live-desktop |
