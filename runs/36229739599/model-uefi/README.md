...
| 11 | install | type | ok | 7.6s | typed 149 characters |
| 12 | install | sleep | ok | 60.0s | slept 60s |
| 13 | install | screenshot | ok | 0.2s | 1440x900 (pillow) |
| 14 | install | wait_serial | failed | 0.2s | serial reported failure: '[   59.200729] sos-vm-test[1692]: SOS-STEP model-failed' |
