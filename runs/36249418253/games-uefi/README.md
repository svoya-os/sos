...
| 4 | desktop | wait_serial | ok | 17.0s | matched 'SOS-MARK 14.50 desktop-ready' |
| 5 | desktop | sleep | ok | 10.0s | slept 10s |
| 6 | desktop | screenshot | ok | 0.8s | 1440x900 (pillow) |
| 7 | network | wait_serial | ok | 0.0s | matched 'SOS-MARK 7.50 network-online' |
...
| 15 | install | wait_serial | ok | 0.0s | matched '[  113.654594] sos-vm-test[5513]: SOS-STEP games-ready' |
...
| 27 | launcher | screenshot | ok | 0.7s | 1440x900 (pillow) |
...
| 35 | steam | screenshot | ok | 0.7s | 1440x900 (pillow) |
...
| 44 | after | key | ok | 0.0s | meta_l+ret |
| 45 | after | sleep | ok | 5.0s | slept 5s |
| 46 | after | type | ok | 7.6s | typed 149 characters |
| 47 | after | sleep | ok | 3.0s | slept 3s |
