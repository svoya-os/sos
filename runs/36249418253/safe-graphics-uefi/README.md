...
| 6 | boot | screenshot | ok | 0.4s | 1280x800 (pillow) |
| 7 | boot | key | ok | 0.0s | ret |
| 8 | plymouth | sleep | ok | 10.0s | slept 10s |
| 9 | plymouth | screenshot | ok | 0.0s | 1280x800 (pillow) |
| 10 | desktop | wait_serial | ok | 5.0s | matched 'SOS-MARK 13.53 desktop-ready' |
| 11 | desktop | sleep | ok | 8.0s | slept 8s |
| 12 | desktop | screenshot | ok | 0.5s | 1280x800 (pillow) |
| 13 | launcher | key | ok | 0.0s | meta_l+spc |
| 14 | launcher | sleep | ok | 3.0s | slept 3s |
| 15 | launcher | screenshot | ok | 0.5s | 1280x800 (pillow), 39.7% changed vs 03-live-desktop |
...
| 20 | jackson | screenshot | ok | 0.6s | 1280x800 (pillow), 25.5% changed vs 03-live-desktop |
