...
| 10 | installer | wait_serial | ok | 2.0s | matched '[   41.114597] sos-vm-test[1781]: SOS-STEP installer-start' |
...
| 42 | install | wait_serial | ok | 88.1s | matched '[  280.645761] sos-installer[9651]: installation finalized' |
...
| 49 | reboot | screenshot | ok | 0.4s | 1440x900 (pillow) |
