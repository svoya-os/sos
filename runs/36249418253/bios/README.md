...
| 3 | boot-menu | screenshot | ok | 0.8s | 1920x1080 (pillow) |
| 4 | boot | key | ok | 0.0s | ret |
| 5 | plymouth | sleep | ok | 10.0s | slept 10s |
| 6 | plymouth | screenshot | ok | 0.2s | 1440x900 (pillow) |
| 7 | desktop | wait_serial | ok | 10.0s | matched 'SOS-MARK 18.34 desktop-ready' |
| 8 | desktop | sleep | ok | 8.0s | slept 8s |
| 9 | desktop | screenshot | ok | 0.9s | 1440x900 (pillow) |
| 10 | network | wait_serial | ok | 0.0s | matched 'SOS-MARK 10.20 network-online' |
