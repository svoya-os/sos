...
| 7 | desktop | wait_serial | ok | 10.0s | matched 'SOS-MARK 17.93 desktop-ready' |
| 8 | desktop | sleep | ok | 8.0s | slept 8s |
| 9 | desktop | screenshot | ok | 1.0s | 1440x900 (pillow) |
| 10 | network | wait_serial | ok | 0.0s | matched 'SOS-MARK 9.75 network-online' |
| 11 | launcher | key | ok | 0.0s | meta_l+spc |
| 12 | launcher | sleep | ok | 3.0s | slept 3s |
| 13 | launcher | screenshot | ok | 1.0s | 1440x900 (pillow), 31.6% changed vs 03-live-desktop |
...
| 18 | jackson | screenshot | ok | 1.2s | 1440x900 (pillow), 21.8% changed vs 03-live-desktop |
