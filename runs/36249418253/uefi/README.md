...
| 7 | desktop | wait_serial | ok | 8.0s | matched 'SOS-MARK 15.63 desktop-ready' |
| 8 | desktop | sleep | ok | 8.0s | slept 8s |
| 9 | desktop | screenshot | ok | 0.9s | 1440x900 (pillow) |
| 10 | network | wait_serial | ok | 0.0s | matched 'SOS-MARK 7.58 network-online' |
...
| 18 | jackson | screenshot | ok | 1.0s | 1440x900 (pillow), 21.8% changed vs 03-live-desktop |
