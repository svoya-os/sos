...
| 2 | boot-menu | wait_screen | ok | 4.2s | screen has content (2.3% non-background) |
| 3 | boot-menu | screenshot | ok | 0.2s | 1920x1080 (pillow) |
| 4 | boot | key | ok | 0.0s | ret |
| 5 | plymouth | sleep | ok | 10.0s | slept 10s |
| 6 | plymouth | screenshot | ok | 0.2s | 1440x900 (pillow) |
| 7 | desktop | wait_serial | ok | 10.0s | matched 'SOS-MARK 18.14 desktop-ready' |
