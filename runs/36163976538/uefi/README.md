...
| 7 | desktop | wait_serial | ok | 6.0s | matched 'SOS-MARK 14.47 desktop-ready' |
| 8 | desktop | sleep | ok | 8.0s | slept 8s |
| 9 | desktop | screenshot | ok | 0.5s | 1440x900 (pillow) |
| 10 | launcher | key | ok | 0.0s | meta_l+spc |
| 11 | launcher | sleep | ok | 3.0s | slept 3s |
| 12 | launcher | screenshot | ok | 0.5s | 1440x900 (pillow), 28.0% changed vs 03-live-desktop |
...
| 17 | jackson | screenshot | ok | 0.5s | 1440x900 (pillow), 18.6% changed vs 03-live-desktop |
