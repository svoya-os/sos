...
| 7 | desktop | wait_serial | ok | 11.0s | matched 'SOS-MARK 18.21 desktop-ready' |
...
| 12 | launcher | screenshot | ok | 1.0s | 1440x900 (pillow), 31.6% changed vs 03-live-desktop |
...
| 17 | jackson | screenshot | ok | 1.2s | 1440x900 (pillow), 21.8% changed vs 03-live-desktop |
