...
| 4 | desktop | wait_serial | ok | 16.0s | matched 'SOS-MARK 14.28 desktop-ready' |
...
| 9 | installer | type | ok | 15.7s | typed 309 characters |
| 10 | installer | sleep | ok | 25.0s | slept 25s |
| 11 | welcome | screenshot | ok | 0.6s | 1440x900 (pillow), 31.3% changed vs 01-live-desktop |
| 12 | welcome | key | ok | 0.0s | alt+n |
| 13 | locale | sleep | ok | 4.0s | slept 4s |
| 14 | locale | screenshot | ok | 0.5s | 1440x900 (pillow) |
| 15 | locale | key | ok | 0.0s | alt+n |
| 16 | keyboard | sleep | ok | 4.0s | slept 4s |
| 17 | keyboard | screenshot | ok | 0.5s | 1440x900 (pillow) |
| 18 | keyboard | key | ok | 0.0s | alt+n |
| 19 | partition | sleep | ok | 8.0s | slept 8s |
| 20 | partition | screenshot | ok | 0.5s | 1440x900 (pillow) |
| 21 | partition | key | ok | 0.0s | alt+n |
| 22 | users | sleep | ok | 4.0s | slept 4s |
| 23 | users | screenshot | ok | 0.5s | 1440x900 (pillow) |
...
| 31 | users | screenshot | ok | 0.5s | 1440x900 (pillow) |
| 32 | users | key | ok | 0.0s | alt+n |
| 33 | summary | sleep | ok | 5.0s | slept 5s |
| 34 | summary | screenshot | ok | 0.5s | 1440x900 (pillow) |
| 35 | summary | key | ok | 0.0s | alt+i |
| 36 | summary | sleep | ok | 3.0s | slept 3s |
| 37 | summary | screenshot | ok | 0.5s | 1440x900 (pillow) |
| 38 | summary | key | ok | 0.0s | alt+i |
| 39 | install | sleep | ok | 90.0s | slept 90s |
| 40 | install | screenshot | ok | 0.5s | 1440x900 (pillow) |
| 41 | install | wait_serial | failed | 2400.1s | timed out waiting for serial pattern 'sos-installer\\S*: installation finalized' |
