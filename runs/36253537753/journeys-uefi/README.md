...
| 4 | desktop | wait_serial | ok | 21.0s | matched 'SOS-MARK 18.22 desktop-ready' |
...
| 9 | cheatsheet | screenshot | ok | 0.7s | 1440x900 (pillow), 30.4% changed vs 01-desktop |
...
| 119 | launcher-eggs | screenshot | ok | 0.6s | 1440x900 (pillow) |
...
| 138 | lock | screenshot | ok | 0.8s | 1440x900 (pillow) |
