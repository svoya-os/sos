...
| 4 | desktop | wait_serial | ok | 21.0s | matched 'SOS-MARK 18.68 desktop-ready' |
| 5 | desktop | sleep | ok | 10.0s | slept 10s |
| 6 | desktop | screenshot | ok | 0.7s | 1440x900 (pillow) |
| 7 | network | wait_serial | ok | 0.0s | matched 'SOS-MARK 10.50 network-online' |
...
| 15 | install | wait_serial | ok | 0.0s | matched '[   96.101764] sos-vm-test[2234]: SOS-STEP model-ready' |
...
| 30 | ask | wait_serial | ok | 443.6s | matched '[  588.902737] jacksond[2256]: INFO jackson.engine: turn done in 449958 ms: local/Qwen3.5-4B-Q4_K_M, 2949+37 tokens' |
| 31 | ask | sleep | ok | 2.0s | slept 2s |
| 32 | ask | screenshot | ok | 0.7s | 1440x900 (pillow) |
| 33 | skill | type | ok | 2.5s | typed 48 characters |
| 34 | skill | wait_serial | ok | 245.3s | matched '[  839.558308] jacksond[2256]: INFO jackson.engine: turn done in 241510 ms: local/Qwen3.5-4B-Q4_K_M, 3793+36 tokens' (#2) |
| 35 | skill | sleep | ok | 2.0s | slept 2s |
| 36 | skill | screenshot | ok | 0.7s | 1440x900 (pillow) |
| 37 | russian | type | ok | 1.8s | typed 34 characters |
| 38 | russian | wait_serial | ok | 126.2s | matched '[  970.094302] jacksond[2256]: INFO jackson.engine: turn done in 123113 ms: local/Qwen3.5-4B-Q4_K_M, 3167+16 tokens' (#3) |
