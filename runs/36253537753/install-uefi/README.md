...
| 4 | desktop | wait_serial | ok | 21.0s | matched 'SOS-MARK 18.69 desktop-ready' |
...
| 10 | installer | wait_serial | ok | 2.0s | matched '[   41.279968] sos-vm-test[1785]: SOS-STEP installer-start' |
...
| 41 | install | screenshot | ok | 0.5s | 1440x900 (pillow) |
| 42 | install | wait_serial | ok | 95.1s | matched '[  286.759241] sos-installer[9668]: installation finalized' |
