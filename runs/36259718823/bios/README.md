...
| 3 | boot-menu | screenshot | ok | 1.0s | 1920x1080 (pillow) |
...
| 10 | network | wait_serial | ok | 0.0s | matched 'SOS-MARK 9.88 network-online' |
...
| 18 | jackson | screenshot | ok | 0.7s | 1440x900 (pillow), 18.6% changed vs 03-live-desktop |
