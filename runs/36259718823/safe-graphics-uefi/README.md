...
| 10 | desktop | wait_serial | ok | 7.0s | matched 'SOS-MARK 14.89 desktop-ready' |
...
| 15 | launcher | screenshot | ok | 0.5s | 1280x800 (pillow), 35.4% changed vs 03-live-desktop |
...
| 20 | jackson | screenshot | ok | 0.5s | 1280x800 (pillow), 21.8% changed vs 03-live-desktop |
