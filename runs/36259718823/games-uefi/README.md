...
| 4 | desktop | wait_serial | ok | 21.0s | matched 'SOS-MARK 18.36 desktop-ready' |
| 5 | desktop | sleep | ok | 10.0s | slept 10s |
| 6 | desktop | screenshot | ok | 0.7s | 1440x900 (pillow) |
| 7 | network | wait_serial | ok | 0.0s | matched 'SOS-MARK 10.20 network-online' |
...
| 15 | install | wait_serial | ok | 1.0s | matched '[  139.074460] sos-vm-test[5527]: SOS-STEP games-ready' |
| 16 | install | sleep | ok | 2.0s | slept 2s |
| 17 | install | screenshot | ok | 0.2s | 1440x900 (pillow) |
| 18 | tools | type | ok | 17.3s | typed 336 characters |
...
| 42 | after | screenshot | ok | 0.5s | 1440x900 (pillow) |
