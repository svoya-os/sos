...
| 4 | desktop | wait_serial | ok | 21.0s | matched 'SOS-MARK 18.05 desktop-ready' |
...
| 15 | install | wait_serial | ok | 0.0s | matched '[   92.168355] sos-vm-test[2206]: SOS-STEP model-ready' |
...
| 27 | ask | screenshot | ok | 1.0s | 1440x900 (pillow) |
| 28 | ask | wait_serial | failed | 35.0s | serial reported failure: '[  166.701321] jacksond[1391]: INFO jackson.engine: turn failed after 40865 ms: The model failed: local: cannot connect to 127.0.0.1:8 |
| 29 | ask | sleep | ok | 2.0s | slept 2s |
| 30 | ask | screenshot | ok | 0.9s | 1440x900 (pillow) |
| 31 | skill | type | ok | 2.5s | typed 48 characters |
| 32 | skill | wait_serial | failed | 154.2s | serial reported failure: '[  325.526932] jacksond[1391]: INFO jackson.engine: turn failed after 148760 ms: The model failed: local: cannot connect to 127.0.0.1: |
| 33 | skill | sleep | ok | 2.0s | slept 2s |
| 34 | skill | screenshot | ok | 0.9s | 1440x900 (pillow) |
| 35 | russian | type | ok | 1.7s | typed 34 characters |
| 36 | russian | wait_serial | failed | 42.0s | serial reported failure: '[  372.796387] jacksond[1391]: INFO jackson.engine: turn failed after 38119 ms: The model failed: local: cannot connect to 127.0.0.1:8 |
| 37 | russian | sleep | ok | 2.0s | slept 2s |
| 38 | russian | screenshot | ok | 0.9s | 1440x900 (pillow) |
