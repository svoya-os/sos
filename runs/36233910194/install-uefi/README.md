...
| 4 | desktop | wait_serial | ok | 21.0s | matched 'SOS-MARK 18.85 desktop-ready' |
...
| 10 | installer | wait_serial | ok | 3.0s | matched '[   41.968962] sos-vm-test[1764]: SOS-STEP installer-start' |
| 11 | installer | sleep | ok | 25.0s | slept 25s |
| 12 | welcome | screenshot | ok | 0.8s | 1440x900 (pillow), 31.3% changed vs 01-live-desktop |
| 13 | welcome | key | ok | 0.0s | alt+n |
| 14 | locale | sleep | ok | 4.0s | slept 4s |
| 15 | locale | screenshot | ok | 0.8s | 1440x900 (pillow) |
| 16 | locale | key | ok | 0.0s | alt+n |
| 17 | keyboard | sleep | ok | 4.0s | slept 4s |
| 18 | keyboard | screenshot | ok | 0.8s | 1440x900 (pillow) |
| 19 | keyboard | key | ok | 0.0s | alt+n |
| 20 | partition | sleep | ok | 8.0s | slept 8s |
| 21 | partition | screenshot | ok | 0.8s | 1440x900 (pillow) |
| 22 | partition | key | ok | 0.0s | alt+n |
| 23 | users | sleep | ok | 4.0s | slept 4s |
| 24 | users | screenshot | ok | 0.8s | 1440x900 (pillow) |
...
| 32 | users | screenshot | ok | 0.8s | 1440x900 (pillow) |
| 33 | users | key | ok | 0.0s | alt+n |
| 34 | summary | sleep | ok | 5.0s | slept 5s |
| 35 | summary | screenshot | ok | 0.8s | 1440x900 (pillow) |
| 36 | summary | key | ok | 0.0s | alt+i |
| 37 | summary | sleep | ok | 3.0s | slept 3s |
| 38 | summary | screenshot | ok | 0.8s | 1440x900 (pillow) |
| 39 | summary | key | ok | 0.0s | alt+i |
| 40 | install | sleep | ok | 90.0s | slept 90s |
| 41 | install | screenshot | ok | 0.8s | 1440x900 (pillow) |
| 42 | install | wait_serial | failed | 2400.6s | timed out waiting for serial pattern 'sos-installer\\S*: installation finalized' |
