...
|---|---|---|---|---|---|
| 1 | boot-menu | wait_serial | ok | 2.0s | matched 'SOS 26.10' |
| 2 | boot-menu | wait_screen | ok | 4.1s | screen has content (2.6% non-background) |
...
| 7 | desktop | wait_serial | ok | 9.0s | matched 'SOS-MARK 16.37 desktop-ready' |
...
| 12 | launcher | screenshot | ok | 0.9s | 1440x900 (pillow), 25.7% changed vs 03-live-desktop |
...
| 17 | jackson | screenshot | ok | 1.1s | 1440x900 (pillow), 13.8% changed vs 03-live-desktop |
