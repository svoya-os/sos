...
| 3 | boot-menu | screenshot | ok | 0.3s | 640x480 (pillow) |
| 4 | boot | key | ok | 0.0s | ret |
| 5 | plymouth | sleep | ok | 10.0s | slept 10s |
| 6 | plymouth | screenshot | ok | 0.0s | 1440x900 (pillow) |
| 7 | desktop | wait_serial | ok | 8.0s | matched 'SOS-MARK 16.13 desktop-ready' |
...
| 12 | launcher | screenshot | ok | 0.8s | 1440x900 (pillow), 25.7% changed vs 03-live-desktop |
...
| 17 | jackson | screenshot | ok | 0.8s | 1440x900 (pillow), 13.8% changed vs 03-live-desktop |
