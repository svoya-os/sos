...
| 2 | boot-menu | wait_screen | ok | 4.2s | screen has content (76.7% non-background) |
| 3 | boot-menu | screenshot | ok | 0.5s | 1280x800 (pillow) |
| 4 | boot | key | ok | 0.0s | down |
| 5 | boot | sleep | ok | 1.0s | slept 1s |
| 6 | boot | screenshot | ok | 0.5s | 1280x800 (pillow) |
| 7 | boot | key | ok | 0.0s | ret |
| 8 | plymouth | sleep | ok | 10.0s | slept 10s |
| 9 | plymouth | screenshot | ok | 0.0s | 1280x800 (pillow) |
| 10 | desktop | wait_serial | ok | 6.0s | matched 'SOS-MARK 13.44 desktop-ready' |
...
| 15 | launcher | screenshot | ok | 0.6s | 1280x800 (pillow), 39.7% changed vs 03-live-desktop |
...
| 20 | jackson | screenshot | ok | 0.7s | 1280x800 (pillow), 25.5% changed vs 03-live-desktop |
