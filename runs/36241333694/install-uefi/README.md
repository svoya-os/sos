...
| 10 | installer | wait_serial | ok | 2.0s | matched '[   41.161264] sos-vm-test[1774]: SOS-STEP installer-start' |
| 11 | installer | sleep | ok | 25.0s | slept 25s |
| 12 | welcome | screenshot | ok | 0.6s | 1440x900 (pillow), 64.6% changed vs 01-live-desktop |
| 13 | welcome | key | ok | 0.0s | alt+n |
| 14 | locale | sleep | ok | 4.0s | slept 4s |
| 15 | locale | screenshot | ok | 0.6s | 1440x900 (pillow) |
...
| 21 | partition | screenshot | ok | 0.5s | 1440x900 (pillow) |
| 22 | partition | key | ok | 0.0s | alt+n |
| 23 | users | sleep | ok | 4.0s | slept 4s |
| 24 | users | screenshot | ok | 0.5s | 1440x900 (pillow) |
...
| 35 | summary | screenshot | ok | 0.5s | 1440x900 (pillow) |
| 36 | summary | key | ok | 0.0s | alt+i |
| 37 | summary | sleep | ok | 3.0s | slept 3s |
| 38 | summary | screenshot | ok | 0.5s | 1440x900 (pillow) |
| 39 | summary | key | ok | 0.0s | alt+i |
| 40 | install | sleep | ok | 90.0s | slept 90s |
| 41 | install | screenshot | ok | 0.6s | 1440x900 (pillow) |
| 42 | install | wait_serial | ok | 88.1s | matched '[  280.833846] sos-installer[9636]: installation finalized' |
| 43 | install | sleep | ok | 30.0s | slept 30s |
| 44 | install | screenshot | ok | 0.5s | 1440x900 (pillow) |
...
| 51 | greeter | screenshot | ok | 0.7s | 1440x900 (pillow) |
| 52 | login | type | ok | 0.9s | typed 17 characters |
| 53 | login | sleep | ok | 45.0s | slept 45s |
| 54 | login | screenshot | ok | 0.9s | 1440x900 (pillow), 100.0% changed vs 12-greeter |
| 55 | login | sleep | ok | 30.0s | slept 30s |
| 56 | login | screenshot | ok | 0.8s | 1440x900 (pillow) |
